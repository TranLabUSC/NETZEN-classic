...
option_list <- list(
  ...
  make_option(c("-u","--consider_positive_values_only"), action="store_true", default=T,
  ...
  make_option(c("-l", "--gene_statistics_list"), action="store", default="logFC,fdr,betweenness",
  ...
  make_option(c("-z", "--steps_combined"), action="store", default=T,
  ...
  make_option(c("-d","--source_node_inclusion"), action="store", default="s",
  ...
  make_option(c("-a","--neighbor_aggregation_method"), action="store", default="s",
